...
import com.voli.service.FlightService;
import com.voli.service.PassengerService;
import com.voli.service.TicketService;
import com.voli.service.UserService;
...
public class BookingController {
	...
	@PostMapping("/booking")
	public String SavePassenger1(Model model, @ModelAttribute("passenger") Passenger passenger,
			@ModelAttribute("tickets") Ticket tickets, @AuthenticationPrincipal UserDetails currentUser) {
